...
class LandParticle(pygame.sprite.Sprite):
    def __init__(self, position: int):
        super(LandParticle, self).__init__()
        self.fps = FPS()
        self.animation_speed = 0.5
        self.frames = ImportSupport.import_folder(texture_dir("character/dust_particles/land"))
